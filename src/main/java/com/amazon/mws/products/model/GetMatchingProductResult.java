...
public class GetMatchingProductResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetMatchingProductResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public GetMatchingProductResult(Product product, java.lang.Error error,String asin,String status) {
        this.product = product;
        this.error = error;
        this.asin = asin;
        this.status = status;
