 ...
 */
package com.amazon.mws.products.model;
...
public class GetLowestOfferListingsForSKUResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetLowestOfferListingsForSKUResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        error = r.read("Error", java.lang.Error.class);
    }
    ...
    /** Value constructor. */
    public GetLowestOfferListingsForSKUResult(Boolean allOfferListingsConsidered,Product product, java.lang.Error error,String sellerSKU,String status) {
        this.allOfferListingsConsidered = allOfferListingsConsidered;
        this.product = product;
        this.error = error;
        this.sellerSKU = sellerSKU;
