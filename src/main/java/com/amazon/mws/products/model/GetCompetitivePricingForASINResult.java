...
public class GetCompetitivePricingForASINResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetCompetitivePricingForASINResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public GetCompetitivePricingForASINResult(Product product, java.lang.Error error,String asin,String status) {
        this.product = product;
        this.error = error;
        this.asin = asin;
        this.status = status;
