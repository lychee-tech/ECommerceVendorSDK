...
public class FeesEstimateResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public FeesEstimateResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public FeesEstimateResult(String status,FeesEstimateIdentifier feesEstimateIdentifier,FeesEstimate feesEstimate, java.lang.Error error) {
        this.status = status;
        this.feesEstimateIdentifier = feesEstimateIdentifier;
        this.feesEstimate = feesEstimate;
        this.error = error;
