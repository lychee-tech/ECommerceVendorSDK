...
public class GetMatchingProductForIdResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetMatchingProductForIdResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public GetMatchingProductForIdResult(ProductList products, java.lang.Error error,String id,String idType,String status) {
        this.products = products;
        this.error = error;
        this.id = id;
        this.idType = idType;
