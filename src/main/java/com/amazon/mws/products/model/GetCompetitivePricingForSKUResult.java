...
public class GetCompetitivePricingForSKUResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetCompetitivePricingForSKUResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public GetCompetitivePricingForSKUResult(Product product, java.lang.Error error,String sellerSKU,String status) {
        this.product = product;
        this.error = error;
        this.sellerSKU = sellerSKU;
        this.status = status;
