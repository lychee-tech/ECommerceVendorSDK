...
public class GetMyPriceForSKUResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetMyPriceForSKUResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public GetMyPriceForSKUResult(Product product, java.lang.Error error,String sellerSKU,String status) {
        this.product = product;
        this.error = error;
        this.sellerSKU = sellerSKU;
        this.status = status;
