...
public class GetLowestOfferListingsForASINResult extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public GetLowestOfferListingsForASINResult withError(java.lang.Error error) {
        this.error = error;
        return this;
    }
    ...
    /** Value constructor. */
    public GetLowestOfferListingsForASINResult(Boolean allOfferListingsConsidered,Product product, java.lang.Error error,String asin,String status) {
        this.allOfferListingsConsidered = allOfferListingsConsidered;
        this.product = product;
        this.error = error;
        this.asin = asin;
